<aside class="left-side sidebar-offcanvas"> 
  ...
  <section class="sidebar"> 
    ...
    <ul class="sidebar-menu">
      ...
      <li> <a href="<?php echo base_url('admin/employers_main');?>"><i class="fa fa-angle-double-right"></i><span>Employers / Companies</span> </a> </li>
      <li> <a href="<?php echo base_url('admin/jobseeker_main');?>"><i class="fa fa-angle-double-right"></i><span>Manage Jobseekers</span> </a> </li>
