...
<aside class="right-side"> 
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
     <div class="col-md-2">
                <a  href="<?php echo base_url('admin/employers');?>"    class="btn btn-success" >Employer</a>
              </div> <div class="col-md-2">
                 <a  href="<?php echo base_url('admin/certifications');?>"    class="btn btn-success" >certification</a>
              </div> <div class="col-md-2">
                <a  href="<?php echo base_url('admin/voulnteers');?>"    class="btn btn-success" >voulnteer</a>
              </div>
			   <div class="col-md-2">
                 <a  href="<?php echo base_url('admin/trainings');?>"    class="btn btn-success" >Training</a>
              </div>
      </div>
    </div>
  </section>
