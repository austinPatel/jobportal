    ...
    <div class="row">
      <div class="col-md-12">
        <div class="candidatesection">          
          <div class="col-md-9">            
            <?php echo form_open_multipart('certification_search',array('name' => 'jsearch', 'id' => 'jsearch'));?>            
    ...
    <div class="searchjoblist col-md-<?php echo $col;?>"> 
      ...
      <div class="searchpage">
        <div class="toptitlebar">
          <div class="row">
            <div class="col-md-6"><b><?php echo $param;?> Certification</b></div>
            <div class="col-md-6 text-right"><strong>certification <?php echo $from_record.' - '.$page;?> of <?php echo $total_rows;?></strong> </div>
          </div>
        </div>
		...
		$CI =& get_instance();
          ...
          <li>
            <div class="row">
              <div class="col-md-2"><a href="<?php echo base_url('certificatins/'.$row->job_slug);?>" class="thumbnail" title="<?php echo $row->job_title;?>"><img src="<?php echo base_url('public/uploads/employer/thumb/'.$company_logo);?>" alt="<?php echo base_url('company/'.$row->company_slug);?>" /></a></div>
              <div class="col-md-10">
