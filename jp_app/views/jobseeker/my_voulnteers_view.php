  ...
  <div class="row">
    ...
    <!--Job Detail-->
      ...
      <div class="formwraper">
        <div class="titlehead">
          <div class="row">
            <div class="col-md-12"><b>My voulnteer Applications</b></div>
          </div>
        </div>
        ...
        <div class="companydescription">
		  ...
		  ?>
                <li class="row" id="aplied_<?php echo $row_applied_job->applied_id;?>">
                  ...
                  <div class="col-md-2 text-right"><a href="javascript:;" onClick="del_applied_voulnteer(<?php echo $row_applied_job->applied_id;?>);" title="Delete" class="delete-ico"><i class="fa fa-times">&nbsp;</i></a></div>
                </li>
                <?php 	endforeach; 
		  		else:?>
                No record found!
