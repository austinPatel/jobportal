...
<div class="container detailinfo">
  <div class="row">
    <div class="col-md-10">
      ...
      <div class="alert alert-info"> <a href="#" class="close" data-dismiss="alert">&times;</a><strong>Heads up!</strong> You have already applied for this training.</div>
      <?php endif;?>
      <div class="row"> 
        ...
        <div class="col-md-4">
          <div class="companyinfoWrp">
            ...
            <div class="jobloc"> <a href="<?php echo base_url('company/'.$row_posted_job->company_slug);?>" class="companyname" title="<?php echo $row_posted_job->company_name;?>"><?php echo $row_posted_job->company_name;?></a>
              ...
              <a href="<?php echo base_url('company/'.$row_posted_job->company_slug);?>" class="currentopen" title="<?php echo $currently_opened_jobs.' Job'.$s.' in '.$row_posted_job->company_name;?>"><?php echo $currently_opened_jobs;?> Current Training<?php echo $s;?> Openings</a> </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="actionBox">
            <h4><?php echo ($is_already_applied=='yes')?'You have already applied for this Training':'To Apply for this training click below';?></h4>
            <p></p>
        ...
        <div class="col-md-8"> 
          ...
          <div class="boxwraper">
            <div class="titlebar">
              <div class="row">
                <div class="col-sm-6">Training Detail</div>
                <?php if($len){?>
            ...
            <div class="row"> 
              ...
              <div class="col-md-12">
                <ul class="reqlist">
                  ...
                  <li>
                    <div class="col-sm-6">Certification Type:</div>
                  ...
                  <li>
                    <div class="col-sm-6">Certification Location:</div>
                  ...
                  <li>
                    <div class="col-sm-6">Training Posting Date:</div>
            ...
            <div class="jobdescription">
              <div class="row">
                <div class="col-md-12">
                  <div class="subtitlebar">Training Description</div>
                  <p>
                ...
                <div class="col-md-12">
                  ...
                  <div class="skillBox">
                    <ul class="skillDetail">
                      ...
                      <li><a href="<?php echo base_url();?>search-trainings/<?php echo make_slug($skill);?>" target="_blank"><?php echo $skill;?></a></li>
                      </li>
                      <?php endforeach;?>
                      <div class="clear"></div>
                    </ul>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Apply For This Training</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" name="submitter3" id="submitter3" class="btn btn-primary">Apply</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            <label>Training: <span style="font-weight:normal;"><?php echo $row_posted_job->job_title;?></span></label>
          </div>
          <div class="form-group">
            <label>Reason</label>
...
$( document ).ready(function() {
	...
	$(".applyjob").click(function(){
		if(is_already_applied=='yes')
			bootbox.alert("You have already applied for this training!");
		else
			$('#japply').modal('show');
	});	
...
$(".applyjob").click(function(){
	...
	$('#msg').html('<div class="alert alert-danger"> <a href="#" class="close" data-dismiss="alert">&times;</a> <strong>Error!</strong> You are not logged in with a jobseeker account. Please re-login with a jobseeker account to apply for this job. </div>');
		return false;
	<?php endif; ?>
		document.location = "<?php echo base_url('/trainings/'.$row_posted_job->job_slug.'?apply=yes');?>";
	});	
$("#scammer").click(function(){
	document.location = "<?php echo base_url('/trainings/'.$row_posted_job->job_slug.'?sc=yes');?>";
});		
</script>
<?php endif;?>
</body>
