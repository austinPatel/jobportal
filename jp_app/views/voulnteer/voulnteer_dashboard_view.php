...
<div class="container detailinfo">
  ...
  <?php $this->load->view('voulnteer/common/category');?>
    <div class="col-md-9">
    <!--  <div class="row"> 
        <!--Company Info-->
     <!--   <div class="col-md-12">
          <div class="userinfoWrp">
            ...
            <div class="col-md-6">
              ...
              <div class="comtxt">Current Openings voulnteer: <?php echo $total_opened_jobs;?></div>
              <div class="comtxt">Staff Members: <?php echo $row->no_of_employees;?></div>
              <div class="comtxt"><a href="<?php echo $row->company_website;?>"  target="_blank"><?php echo $row->company_website;?></a></div>
            </div>
            <div class="col-md-4">
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            <div class="col-md-9"><b>voulnteer Applications Received</b></div>
            <div class="col-md-3 text-right"><a href="<?php echo base_url('voulnteer/voulnteer_applications');?>">View All</a></div>
          </div>
        </div>
        ...
        <div class="experiance">
		  ...
		  ?>
            <li class="row">
              ...
              <div class="col-md-4"><a href="<?php echo base_url('voulnteers/'.$row_applied_job->job_slug);?>"><?php echo $row_applied_job->job_title;?></a></div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            <div class="col-md-9"><b>Current Voulnteer in <?php echo $row->company_name;?></b></div>
            <div class="col-md-3 text-right"><a href="<?php echo base_url('voulnteer/post_new_voulnteer');?>">Post a New Job</a>&nbsp;<a href="<?php echo base_url('voulnteer/my_posted_voulnteer');?>">View All</a></div>
          </div>
        </div>
        ...
        <div class="row searchlist"> 
          ...
          <div class="col-md-12" id="pj_<?php echo $row_jobs->ID;?>">
            <div class="intlist">
              <div class="col-md-12">
                <div class="col-md-8"> <a href="<?php echo base_url('voulnteers/'.$row_jobs->job_slug);?>" class="jobtitle"><?php echo word_limiter(strip_tags($row_jobs->job_title),9);?></a>
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo base_url('voulnteer/edit_posted_voulnteer/'.$row_jobs->ID);?>" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a>
