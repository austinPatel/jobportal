 ...
 <div class="container"> 
    ...
    <ul class="slides">
     ...
     <li class="col-md-3 col-sm-3">
        <a <?php echo active_link('search-jobs');?>><a href="<?php echo base_url('search-jobs');?>"><div class="iconcircle"><img src="<?php echo $base_url;?>public/images/category/mobilisation.png" width="70px" height="70px" style="margin-top: 13px;" ></div>
        <h4 >Mobilisation</h4></a>
      </li>
      <!--step 1 end--> 
      
	  <li class="col-md-3 col-sm-3">
         <a <?php echo active_link('search-jobs');?>><a href="<?php echo base_url('search-jobs');?>"><div class="iconcircle"><img src="<?php echo $base_url;?>public/images/category/training.png" width="60px" height="60px" style="margin-top: 13px;"></div>
        <h4>Training</h4></a>
       </li>

	  <li class="col-md-3 col-sm-3">
        <a <?php echo active_link('search-jobs');?>><a href="<?php echo base_url('search-jobs');?>"><div class="iconcircle"><img src="<?php echo $base_url;?>public/images/category/offertraining2.png" width="70px" height="70px" style="margin-top: 13px;"></div>
        <h4>Offer training</h4></a>
       </li>

      <!--step 2-->
      <li class="col-md-3 col-sm-3">
        <a <?php echo active_link('search-jobs');?>><a href="<?php echo base_url('search-jobs');?>"><div class="iconcircle"><img src="<?php echo $base_url;?>public/images/category/funding.png" width="70px" height="70px" style="margin-top: 13px;"></div>
        <h4>RWF</h4></a>
