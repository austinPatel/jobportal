  ...
  <div class="dashiconwrp">
    ...
    <div class="paginationWrap"> <?php echo ($result_posted_jobs)?$links:'';?> </div>
      ...
      <div class="formwraper">
        <div class="titlehead">
          <div class="row">
            <div class="col-md-12"><b>All Posted Certification</b></div>
          </div>
        </div>
            ...
            <div class="intlist">
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo base_url()?>certification/edit_posted_certification/<?php echo $row_jobs->ID;?>" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a>
