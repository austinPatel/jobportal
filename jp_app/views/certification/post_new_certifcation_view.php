...
<div class="container detailinfo">
  ...
  <?php echo form_open_multipart('certification/post_new_certification',array('name' => 'post_job_form', 'id' => 'post_job_form', 'onSubmit' => 'return validate_new_post_job_form(this);'));?>
    <div class="col-md-9">
      <div class="formwraper">
        <div class="titlehead">Post New </div>
        <div class="formint">
          ...
          <div class="input-group <?php echo (form_error('job_title'))?'has-error':'';?>">
            <label class="input-group-addon">Certification Title <span>*</span></label>
            <input name="job_title" type="text" class="form-control" id="job_title" placeholder="Certification Title" value="<?php echo set_value('job_title'); ?>" maxlength="150">
            <?php echo form_error('job_title'); ?> </div>
          <div class="input-group <?php echo (form_error('vacancies'))?'has-error':'';?>">
            <label class="input-group-addon">No.of Course <span>*</span></label>
          ...
          <div class="input-group <?php echo (form_error('job_mode'))?'has-error':'';?>">
            <label class="input-group-addon">Certification Mode <span>*</span></label>
         ...
         <div class="input-group <?php echo (form_error('pay'))?'has-error':'';?>">
          ...
          <div class="input-group <?php echo (form_error('job_description'))?'has-error':'';?>">
            <label class="input-group-addon">Certification Description</label>
      ...
      <!--Required Skills-->
      <div class="formwraper">
        <div class="titlehead">Please choose the set of skills (Certification) you are looking to hire.</div>
        <div class="formint">
