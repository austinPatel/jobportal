...
<div class="container detailinfo">
  <div class="row">
    <div class="col-md-10">
      ...
      <div class="alert alert-info"> <a href="#" class="close" data-dismiss="alert">&times;</a><strong>Heads up!</strong> You have already applied for this certification.</div>
      <?php endif;?>
      <div class="row"> 
        ...
        <div class="col-md-4">
          ...
          <div class="actionBox">
            <h4><?php echo ($is_already_applied=='yes')?'You have already applied for this certification':'To Apply for this certification click below';?></h4>
            <p></p>
        ...
        <div class="col-md-8"> 
          ...
          <div class="boxwraper">
            <div class="titlebar">
              <div class="row">
                <div class="col-sm-6">Certificcation Detail</div>
                <?php if($len){?>
            ...
            <div class="row"> 
              ...
              <div class="col-md-12">
                <ul class="reqlist">
                  ...
                  <li>
                    <div class="col-sm-6">Certificationn Posting Date:</div>
            ...
            <div class="jobdescription">
              <div class="row">
                <div class="col-md-12">
                  <div class="subtitlebar">Certification Description</div>
                  <p>
                ...
                <div class="col-md-12">
                  ...
                  <div class="skillBox">
                    <ul class="skillDetail">
                      ...
                      <li><a href="<?php echo base_url();?>search-certifications/<?php echo make_slug($skill);?>" target="_blank"><?php echo $skill;?></a></li>
                      </li>
                      <?php endforeach;?>
                      <div class="clear"></div>
                    </ul>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Apply For This Certification</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" name="submitter1" id="submitter1" class="btn btn-primary">Apply</button>
      </div>
    </div>
  </div>
</div>
...
$( document ).ready(function() {
	...
	$(".applyjob").click(function(){
		if(is_already_applied=='yes')
			bootbox.alert("You have already applied for this certification!");
		else
			$('#japply').modal('show');
	});	
...
$(".applyjob").click(function(){
	...
	$('#msg').html('<div class="alert alert-danger"> <a href="#" class="close" data-dismiss="alert">&times;</a> <strong>Error!</strong> You are not logged in with a jobseeker account. Please re-login with a jobseeker account to apply for this certification. </div>');
		return false;
	<?php endif; ?>
		document.location = "<?php echo base_url('/certifications/'.$row_posted_job->job_slug.'?apply=yes');?>";
	});	
$("#scammer").click(function(){
	document.location = "<?php echo base_url('/certifications/'.$row_posted_job->job_slug.'?sc=yes');?>";
});		
</script>
<?php endif;?>
</body>
