...
<!--/Search Block--> 
 ...
 <div class="container"> 
    ...
    <div class="titlebar">
        <div class="subtitle"><h3>PURPOSE OF <span>ASSOCIATION</span></h3></div>
    </div>
    <!-- title end -->
    <ul class="slides">
      <!--step 1-->
      <li class="col-md-3 col-sm-3">
        <a <?php echo active_link('search-jobs');?>><a href="<?php echo base_url('search-jobs');?>"><div class="iconcircle"><img src="<?php echo $base_url;?>public/images/category/job.png" width="70px" height="70px" style="margin-top: 13px;" ></div>
        <h4 >Are you looking for a Job</h4></a>
      </li>
      <!--step 1 end--> 
      
	  <li class="col-md-3 col-sm-3">
         <a <?php echo active_link('search-jobs');?>><a href="<?php echo base_url('search-jobs');?>"><div class="iconcircle"><img src="<?php echo $base_url;?>public/images/category/certification.png" width="60px" height="60px" style="margin-top: 13px;"></div>
        <h4>Looking for certification</h4></a>
       </li>

	  <li class="col-md-3 col-sm-3">
        <a <?php echo active_link('search-jobs');?>><a href="<?php echo base_url('search-jobs');?>"><div class="iconcircle"><img src="<?php echo $base_url;?>public/images/category/offertraining.png" width="70px" height="70px" style="margin-top: 13px;"></div>
        <h4>Offer training</h4></a>
       </li>

      <!--step 2-->
      <li class="col-md-3 col-sm-3">
        <a <?php echo active_link('search-jobs');?>><a href="<?php echo base_url('search-jobs');?>"><div class="iconcircle"><img src="<?php echo $base_url;?>public/images/category/volunteer.png" width="70px" height="70px" style="margin-top: 13px;"></div>
        <h4>Volunteer</h4></a>
...
<div class="container">
        ...
        <ul class="employersList">
		 ...
		 ?>
          <li ><a href="<?php echo base_url('company/'.$row_top_employer->company_slug);?>" title="Jobs in <?php echo $row_top_employer->company_name;?>">
		  <img src="<?php echo base_url('public/uploads/employer/thumb/'.$company_image_name);?>" alt="<?php echo base_url('company/'.$row_top_employer->company_slug);?>" /></a></li>
          <?php
		  		endforeach;
			endif;
		  ?>
	  ...
	  ?>
            <li class="col-md-6">
              <div class="intlist">
				...
				<img src="<?php echo base_url('public/uploads/employer/thumb/'.$image_name);?>" alt="<?php echo base_url('company/'.$row_latest_jobs->company_slug);?>" /></a></div>
