  ...
  <div class="dashiconwrp">
    ...
    <div class="paginationWrap"> <?php echo ($result_posted_jobs)?$links:'';?> </div>
      ...
      <div class="formwraper">
        <div class="titlehead">
          <div class="row">
            <div class="col-md-12"><b>All Posted Training</b></div>
          </div>
        </div>
        ...
        <div class="row searchlist"> 
            ...
            <div class="intlist">
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo base_url()?>training/edit_posted_training/<?php echo $row_jobs->ID;?>" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a>
          ...
          <?php 
				...
				?>
          <div align="center" class="text-red">No Training posted.</div>
          <?php endif;?>
        </div>
      </div>
      <div class="paginationWrap"> <?php echo ($result_posted_jobs)?$links:'';?> </div>
