    ...
    <div class="col-md-9">
     <!-- <div class="row"> 
       ...
       <!-- <div class="col-md-12">
          <div class="userinfoWrp">
            ...
            <div class="col-md-6">
              ...
              <div class="comtxt">Current Openings certification: <?php echo $total_opened_jobs;?></div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            <div class="col-md-9"><b>Training Applications Received</b></div>
            <div class="col-md-3 text-right"><a href="<?php echo base_url('training/training_applications');?>">View All</a></div>
          </div>
        </div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            <div class="col-md-9"><b>Current Training in <?php echo $row->company_name;?></b></div>
            <div class="col-md-3 text-right"><a href="<?php echo base_url('traioning/post_new_training');?>">Post a New Job</a>&nbsp;<a href="<?php echo base_url('training/my_posted_training');?>">View All</a></div>
          </div>
        </div>
        ...
        <div class="row searchlist"> 
          ...
          <div class="col-md-12" id="pj_<?php echo $row_jobs->ID;?>">
            <div class="intlist">
              <div class="col-md-12">
                <div class="col-md-8"> <a href="<?php echo base_url('trainings/'.$row_jobs->job_slug);?>" class="jobtitle"><?php echo word_limiter(strip_tags($row_jobs->job_title),9);?></a>
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo base_url('training/edit_posted_training/'.$row_jobs->ID);?>" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a>
          ...
          <?php 
				...
				?>
          <div align="center" class="text-red">No job Training</div>
          <?php endif;?>
        </div>
      </div>
    </div>
