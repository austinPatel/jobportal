...
class Edit_Jobseeker extends CI_Controller {
	...
	public function delete_applied_certification(){
		...
		$this->applied_certification_model->delete_applied_job_by_id_seeker_id($this->input->post('id'), $this->session->userdata('user_id'));
		echo "done";
		
	}
	
	
	public function delete_applied_voulnteer(){
		...
		$this->applied_voulnteer_model->delete_applied_job_by_id_seeker_id($this->input->post('id'), $this->session->userdata('user_id'));
		echo "done";
	...
	public function delete_applied_training(){
		...
		$this->applied_training_model->delete_applied_job_by_id_seeker_id($this->input->post('id'), $this->session->userdata('user_id'));
		echo "done";
