...
function delete_job_voulnteer(id){
	var myurl = baseUrl+'admin/posted_voulnteers/delete_posted_voulnteer/'+id;
	var is_confirm = confirm("Are you sure you want to delete this jobseeker and associated jobs with him/her?");
	if(is_confirm){
		  $.get(myurl, function (sts) {
			  if(sts=='done')
...
function delete_job_training(id){
	var myurl = baseUrl+'admin/posted_trainings/delete_posted_training/'+id;
	var is_confirm = confirm("Are you sure you want to delete this jobseeker and associated jobs with him/her?");
	if(is_confirm){
		  $.get(myurl, function (sts) {
			  if(sts=='done')
...
function update_posted_certification_status(id){
	var current_status = $("#sts_"+id+" span").html();
	var myurl = baseUrl+'admin/posted_certifications/status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='active')
			var class_label = 'danger';
...
function update_posted_voulnteer_status(id){
	var current_status = $("#sts_"+id+" span").html();
	var myurl = baseUrl+'admin/posted_voulnteers/status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='active')
			var class_label = 'danger';
...
function update_posted_training_status(id){
	var current_status = $("#sts_"+id+" span").html();
	var myurl = baseUrl+'admin/posted_trainings/status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='active')
			var class_label = 'danger';
...
function delete_job_certification(id){
	var myurl = baseUrl+'admin/posted_certifications/delete_posted_certification/'+id;
	var is_confirm = confirm("Are you sure you want to delete this job and associated application(s) submitted against it?");
	if(is_confirm){
		  $.get(myurl, function (sts) {
			  if(sts=='done')
...
function update_featured_certification(id){
	var current_status = $("#f_"+id+" span").html();
	var myurl = baseUrl+'admin/posted_certifications/featured_status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='yes')
			var class_label = 'warning';
...
function update_featured_voulnteer(id){
	var current_status = $("#f_"+id+" span").html();
	var myurl = baseUrl+'admin/posted_voulnteers/featured_status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='yes')
			var class_label = 'warning';
...
function update_featured_training(id){
	var current_status = $("#f_"+id+" span").html();
	var myurl = baseUrl+'admin/posted_trainings/featured_status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='yes')
			var class_label = 'warning';
