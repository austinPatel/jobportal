...
function apply_certification(){
	...
	if(returnval){
		...
		$.ajax({
				type: "POST",
				url: baseUrl+"jobseeker/apply_certification",
				data: { jid: $("#jid").val(), cv: $("#cv").val(), cover_letter: $("#cover_letter").val(), expected_salary: $("#expected_salary").val() }
			  })
				.done(function( msg ) {
					if(msg=='done'){
						...
						$('#emsg').html('');
						is_already_applied = 'yes';
						$('#msg').html('<div class="alert alert-success"> <a href="#" class="close" data-dismiss="alert">&times;</a> <strong>Success!</strong> You have successfully applied for this certification. </div>');	
						$('.actionBox').html('<h4>You have already applied for this certification</h4> <a href="javascript:;" class="applyjobgray"><span>Apply Now</span></a>');
					}
					else
					{
						$('#msg').html('');
...
function apply_voulnteer(){
	...
	if(returnval){
		...
		$.ajax({
				type: "POST",
				url: baseUrl+"jobseeker/apply_voulnteer",
				data: { jid: $("#jid").val(), cv: $("#cv").val(), cover_letter: $("#cover_letter").val(), expected_salary: $("#expected_salary").val() }
			  })
				.done(function( msg ) {
					if(msg=='done'){
						...
						$('#emsg').html('');
						is_already_applied = 'yes';
						$('#msg').html('<div class="alert alert-success"> <a href="#" class="close" data-dismiss="alert">&times;</a> <strong>Success!</strong> You have successfully applied for this voulnteer. </div>');	
						$('.actionBox').html('<h4>You have already applied for this voulnteer</h4> <a href="javascript:;" class="applyjobgray"><span>Apply Now</span></a>');
					}
					else
					{
						$('#msg').html('');
...
function apply_training(){
	...
	if(returnval){
		...
		$.ajax({
				type: "POST",
				url: baseUrl+"jobseeker/apply_training",
				data: { jid: $("#jid").val(), cv: $("#cv").val(), cover_letter: $("#cover_letter").val(), expected_salary: $("#expected_salary").val() }
			  })
				.done(function( msg ) {
					if(msg=='done'){
						...
						$('#emsg').html('');
						is_already_applied = 'yes';
						$('#msg').html('<div class="alert alert-success"> <a href="#" class="close" data-dismiss="alert">&times;</a> <strong>Success!</strong> You have successfully applied for this training. </div>');	
						$('.actionBox').html('<h4>You have already applied for this training</h4> <a href="javascript:;" class="applyjobgray"><span>Apply Now</span></a>');
					}
					else
					{
						$('#msg').html('');
...
function del_applied_voulnteer(id){

		confirmed = confirm("Are you sure you want to delete this applied voulnteer?");
		if(confirmed){
			$('#aplied_'+id).fadeOut();
			$.ajax({
					type: "POST",
					url: baseUrl+"jobseeker/edit_jobseeker/delete_applied_voulnteer",
					data: { id: id}
				  })
					.done(function( msg ) {
						if(msg=='done'){
...
function del_applied_certification(id){

		confirmed = confirm("Are you sure you want to delete this applied certification?");
		if(confirmed){
			$('#aplied_'+id).fadeOut();
			$.ajax({
					type: "POST",
					url: baseUrl+"jobseeker/edit_jobseeker/delete_applied_certification",
					data: { id: id}
				  })
					.done(function( msg ) {
						if(msg=='done'){
...
function del_applied_training(id){

		confirmed = confirm("Are you sure you want to delete this applied training?");
		if(confirmed){
			$('#aplied_'+id).fadeOut();
			$.ajax({
					type: "POST",
					url: baseUrl+"jobseeker/edit_jobseeker/delete_applied_training",
					data: { id: id}
				  })
					.done(function( msg ) {
						if(msg=='done'){
