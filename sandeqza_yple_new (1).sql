...
--
-- Host: localhost:3306
-- Generation Time: Oct 30, 2017 at 11:18 AM
...
-- Procedures
--
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_active_opened_certification_by_company_id`(IN `comp_id` INT(11))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_active_opened_jobs`()
BEGIN
		SELECT COUNT(ID) as total
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_active_opened_jobs_by_company_id`(IN `comp_id` INT(11))
BEGIN
		SELECT COUNT(ID) as total
	FROM `pp_post_jobs` AS pj
	WHERE pj.company_ID=comp_id AND pj.sts='active';
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_active_opened_training_by_company_id`(IN `comp_id` INT(11))
BEGIN
		SELECT COUNT(ID) as total
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_active_opened_voulnteer_by_company_id`(IN `comp_id` INT(11))
BEGIN
		SELECT COUNT(ID) as total
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_active_records_by_city_front_end`(IN `city` VARCHAR(40))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_active_records_by_industry_front_end`(IN `industry_id` INT(11))
BEGIN
	SELECT COUNT(pj.ID) AS total
	FROM `pp_post_jobs` AS pj
	INNER JOIN pp_companies AS pc ON pj.company_ID=pc.ID
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_all_posted_certification_by_company_id_frontend`(IN `comp_id` INT(11))
BEGIN
		SELECT COUNT(pj.ID) AS total
	FROM `pp_post_certification` AS pj
	INNER JOIN pp_companies AS pc ON pj.company_ID=pc.ID
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_all_posted_jobs_by_company_id_frontend`(IN `comp_id` INT(11))
BEGIN
		SELECT COUNT(pj.ID) AS total
	FROM `pp_post_jobs` AS pj
	INNER JOIN pp_companies AS pc ON pj.company_ID=pc.ID
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_applied_certification_by_employer_id`(IN `employer_id` INT(11))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_applied_jobs_by_employer_id`(IN `employer_id` INT(11))
BEGIN
	SELECT COUNT(pp_seeker_applied_for_job.ID) AS total
	FROM `pp_seeker_applied_for_job`
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_applied_jobs_by_jobseeker_id`(IN `jobseeker_id` INT(11))
BEGIN
	SELECT COUNT(pp_seeker_applied_for_job.ID) AS total
	FROM `pp_seeker_applied_for_job`
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_ft_job_search_filter_3`(IN `param_city` VARCHAR(255), `param_company_slug` VARCHAR(255), `param_title` VARCHAR(255))
BEGIN
	SELECT COUNT(pj.ID) as total
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_ft_search_certification`(IN `param` VARCHAR(255), IN `param2` VARCHAR(255))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_ft_search_job`(IN `param` VARCHAR(255), `param2` VARCHAR(255))
BEGIN
	SELECT COUNT(pc.ID) as total
	FROM `pp_post_jobs` pj 
	INNER JOIN pp_companies AS pc ON pj.company_ID=pc.ID
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_ft_search_resume`(IN `param` VARCHAR(255))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `count_search_posted_jobs`(IN `where_condition` VARCHAR(255))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `ft_job_search_filter_3`(IN `param_city` VARCHAR(255), `param_company_slug` VARCHAR(255), `param_title` VARCHAR(255), `from_limit` INT(5), `to_limit` INT(5))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `ft_search_certification`(IN `param` VARCHAR(255), IN `param2` VARCHAR(255), IN `from_limit` INT(5), IN `to_limit` INT(5))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `ft_search_job`(IN `param` VARCHAR(255), `param2` VARCHAR(255), `from_limit` INT(5), `to_limit` INT(5))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `ft_search_jobs_group_by_city`(IN `param` VARCHAR(255))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `ft_search_jobs_group_by_company`(IN `param` VARCHAR(255))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `ft_search_jobs_group_by_salary_range`(IN `param` VARCHAR(255))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `ft_search_jobs_group_by_title`(IN `param` VARCHAR(255))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `ft_search_resume`(IN `param` VARCHAR(255), `from_limit` INT(5), `to_limit` INT(5))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_active_deactive_posted_certification_by_company_id`(IN `comp_id` INT(11), IN `from_limit` INT(4), IN `to_limit` INT(4))
    NO SQL
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_active_deactive_posted_job_by_company_id`(IN `comp_id` INT(11), `from_limit` INT(4), `to_limit` INT(4))
BEGIN
		SELECT pj.ID, pj.job_title, pj.job_slug, pj.job_description, pj.employer_ID, pj.last_date, pj.dated, pj.city, pj.is_featured, pj.sts, pc.company_name, pc.company_logo
	FROM `pp_post_jobs` AS pj
	INNER JOIN pp_companies AS pc ON pj.company_ID=pc.ID
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_active_deactive_posted_training_by_company_id`(IN `comp_id` INT(11), IN `from_limit` INT(4), IN `to_limit` INT(4))
BEGIN
		SELECT pj.ID, pj.job_title, pj.job_slug, pj.job_description, pj.employer_ID, pj.last_date, pj.dated, pj.city, pj.is_featured, pj.sts, pc.company_name, pc.company_logo
	FROM `pp_post_training` AS pj
	INNER JOIN pp_companies AS pc ON pj.company_ID=pc.ID
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_active_deactive_posted_voulnteer_by_company_id`(IN `comp_id` INT(11), IN `from_limit` INT(4), IN `to_limit` INT(4))
BEGIN
		SELECT pj.ID, pj.job_title, pj.job_slug, pj.job_description, pj.employer_ID, pj.last_date, pj.dated, pj.city, pj.is_featured, pj.sts, pc.company_name, pc.company_logo
	FROM `pp_post_voulnteer` AS pj
	INNER JOIN pp_companies AS pc ON pj.company_ID=pc.ID
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_active_featured_job`(IN `from_limit` INT(5), `to_limit` INT(5))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_active_posted_certification_by_id`(IN `job_id` INT(11))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_active_posted_job_by_company_id`(IN `comp_id` INT(11), `from_limit` INT(4), `to_limit` INT(4))
BEGIN
		SELECT pj.ID, pj.job_title, pj.job_slug, pj.job_description, pj.employer_ID, pj.last_date, pj.dated, pj.city, pj.is_featured, pj.sts, pc.company_name, pc.company_logo
	FROM `pp_post_jobs` AS pj
	INNER JOIN pp_companies AS pc ON pj.company_ID=pc.ID
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_active_posted_job_by_id`(IN `job_id` INT(11))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_active_posted_training_by_id`(IN `job_id` INT(11))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_active_posted_voulnteer_by_id`(IN `job_id` INT(11))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_all_active_employers`(IN `from_limit` INT(5), `to_limit` INT(5))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_all_active_top_employers`(IN `from_limit` INT(5), `to_limit` INT(5))
BEGIN
	SELECT pc.ID AS CID, pc.company_name, pc.company_logo, pc.company_slug
	FROM `pp_employers` emp 
	INNER JOIN pp_companies AS pc ON emp.company_ID=pc.ID
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_all_opened_jobs`(IN `from_limit` INT(5), `to_limit` INT(5))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_all_posted_certification`(IN `from_limit` INT(5), IN `to_limit` INT(5))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_all_posted_jobs`(IN `from_limit` INT(5), `to_limit` INT(5))
BEGIN
		SELECT pj.ID, pj.job_title, pj.job_slug, pj.employer_ID, pj.company_ID, pj.job_description, pj.city, pj.dated, pj.last_date, pj.is_featured, pj.sts, pc.company_name, pc.company_logo, pc.company_slug, pj.ip_address 
	FROM `pp_post_jobs` pj 
	INNER JOIN pp_companies AS pc ON pj.company_ID=pc.ID 
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_all_posted_jobs_by_company_id_frontend`(IN `comp_id` INT(11), `from_limit` INT(4), `to_limit` INT(4))
BEGIN
		SELECT pj.ID, pj.job_title, pj.job_slug, pj.job_description, pj.employer_ID, pj.last_date, pj.dated, pj.city, pj.is_featured, pj.sts, pc.company_name, pc.company_logo
	FROM `pp_post_jobs` AS pj
	INNER JOIN pp_companies AS pc ON pj.company_ID=pc.ID
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_all_posted_jobs_by_status`(IN `job_status` VARCHAR(10), `from_limit` INT(5), `to_limit` INT(5))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_applied_certification_by_employer_id`(IN `employer_id` INT(11), IN `from_limit` INT(5), IN `to_limit` INT(5))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_applied_jobs_by_employer_id`(IN `employer_id` INT(11), `from_limit` INT(5), `to_limit` INT(5))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_applied_jobs_by_jobseeker_id`(IN `jobseeker_id` INT(11), `from_limit` INT(5), `to_limit` INT(5))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_applied_jobs_by_seeker_id`(IN `applicant_id` INT(11), `from_limit` INT(5), `to_limit` INT(5))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_applied_training_by_employer_id`(IN `employer_id` INT(11), IN `from_limit` INT(4), IN `to_limit` INT(4))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_applied_voulnteer_by_employer_id`(IN `employer_id` INT(11), IN `from_limit` INT(4), IN `to_limit` INT(4))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_company_by_slug`(IN `slug` VARCHAR(70))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_experience_by_jobseeker_id`(IN `jobseeker_id` INT(11))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_featured_job`(IN `from_limit` INT(5), `to_limit` INT(5))
BEGIN
		SELECT pj.ID, pj.job_title, pj.job_slug, pj.employer_ID, pj.company_ID, pj.city, pj.dated, pj.last_date, pj.is_featured, pj.sts, pc.company_name, pc.company_logo, pc.company_slug 
	FROM `pp_post_jobs` pj 
	LEFT JOIN pp_companies AS pc ON pj.company_ID=pc.ID 
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_latest_posted_job_by_employer_ID`(IN `emp_id` INT(11), `from_limit` INT(4), `to_limit` INT(4))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_opened_jobs_home_page`(IN `from_limit` INT(5), `to_limit` INT(5))
BEGIN
set @prev := 0, @rownum := '';
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_posted_job_by_company_id`(IN `comp_id` INT(11), `from_limit` INT(4), `to_limit` INT(4))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_posted_job_by_employer_id`(IN `emp_id` INT(11), `from_limit` INT(4), `to_limit` INT(4))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_posted_job_by_id`(IN `job_id` INT(11))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_posted_job_by_id_certification_id`(IN `job_id` INT(11), IN `emp_id` INT(11))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_posted_job_by_id_employer_id`(IN `job_id` INT(11), IN `emp_id` INT(11))
BEGIN
	SELECT pp_post_jobs.*, pc.ID AS CID, pp_job_industries.industry_name, pc.company_name, pc.company_email, pc.company_ceo, pc.company_description, pc.company_logo, pc.company_phone, pc.company_website, pc.company_fax,pc.no_of_offices, pc.no_of_employees, pc.established_in, pc.industry_ID AS cat_ID, pc.company_location, pc.company_slug
	FROM `pp_post_jobs` 
	INNER JOIN pp_companies AS pc ON pp_post_jobs.company_ID=pc.ID
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_posted_job_by_id_training_id`(IN `job_id` INT(11), IN `emp_id` INT(11))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_posted_job_by_id_voulnteer_id`(IN `job_id` INT(11), IN `emp_id` INT(11))
BEGIN
	SELECT pp_post_voulnteer.*, pc.ID AS CID, pp_job_industries.industry_name, pc.company_name, pc.company_email, pc.company_ceo, pc.company_description, pc.company_logo, pc.company_phone, pc.company_website, pc.company_fax,pc.no_of_offices, pc.no_of_employees, pc.established_in, pc.industry_ID AS cat_ID, pc.company_location, pc.company_slug
	FROM `pp_post_voulnteer` 
	INNER JOIN pp_companies AS pc ON pp_post_voulnteer.company_ID=pc.ID
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `get_qualification_by_jobseeker_id`(IN `jobseeker_id` INT(11))
BEGIN
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `job_search_by_city`(IN `param_city` VARCHAR(255), `from_limit` INT(5), `to_limit` INT(5))
BEGIN
	SELECT pj.ID, pj.job_title, pj.job_slug, pj.employer_ID, pj.company_ID, pj.job_description, pj.city, pj.dated, pj.last_date, pj.is_featured, pj.sts, pc.company_name, pc.company_logo, pc.company_slug
	FROM pp_post_jobs pj
	INNER JOIN pp_companies pc ON pc.ID = pj.company_ID 
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `job_search_by_industry`(IN `param` VARCHAR(255), `from_limit` INT(5), `to_limit` INT(5))
BEGIN
	SELECT pj.ID, pj.job_title, pj.job_slug, pj.employer_ID, pj.company_ID, pj.job_description, pj.city, pj.dated, pj.last_date, pj.is_featured, pj.sts, pc.company_name, pc.company_logo, pc.company_slug
	FROM pp_post_jobs pj
	INNER JOIN pp_companies pc ON pc.ID = pj.company_ID 
...
CREATE DEFINER=`sandeqza`@`localhost` PROCEDURE `search_posted_jobs`(IN `where_condition` VARCHAR(255), `from_limit` INT(11), `to_limit` INT(11))
BEGIN
...
CREATE TABLE IF NOT EXISTS `pp_ad_codes` (
...
CREATE TABLE IF NOT EXISTS `pp_cities` (
...
CREATE TABLE IF NOT EXISTS `pp_cms` (
...
CREATE TABLE IF NOT EXISTS `pp_cms_previous` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pp_companies` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pp_countries` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pp_email_content` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pp_employers` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
(3, 3, 'test3@test3.com', 'test123', 'Danny', NULL, 'Australia', 'Sydney', '123456789', NULL, '0000-00-00', 'active', NULL, '0', NULL, '2017-10-04 01:35:29', '2017-10-30 04:10:47', '115.186.165.234', NULL, NULL, NULL, 'no'),
...
CREATE TABLE IF NOT EXISTS `pp_favourite_candidates` (
...
CREATE TABLE IF NOT EXISTS `pp_favourite_companies` (
...
CREATE TABLE IF NOT EXISTS `pp_institute` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pp_job_alert` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pp_job_alert_queue` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pp_job_functional_areas` (
...
CREATE TABLE IF NOT EXISTS `pp_job_industries` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 PACK_KEYS=0 AUTO_INCREMENT=145 ;
...
CREATE TABLE IF NOT EXISTS `pp_job_seekers` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
(54, 'sayed ahmed', NULL, 'sayed.homeeg@gmail.com', 'sayed1212', '92 eltahrir street\n92 Eltahrir Street', NULL, '2016-04-06 12:04:09', 'China', 'fdsfsdf', 'male', '1981-01-01', NULL, 'no-image.jpg', 0, '43423423', 'fdsf', NULL, 'Australia', NULL, 'active', NULL, NULL, NULL, NULL, '82.201.186.129', NULL, NULL, NULL, 'yes'),
...
(57, 'Rushabh', NULL, 'rushabh.shah328@gmail.com', '123456', 'Neminath', NULL, '2016-04-07 11:58:57', 'Australia', 'kkk', 'male', '1991-01-01', NULL, 'no-image.jpg', 0, '123456789', '', NULL, 'Australia', NULL, 'active', NULL, NULL, NULL, NULL, '223.255.245.113', NULL, NULL, NULL, 'yes'),
...
(142, 'qsaf', NULL, 'zied.ds@hh.ds', '123456', 'qsf', NULL, '2016-06-15 14:06:39', 'Canada', 'sqdfqsf', 'male', '1980-08-13', NULL, 'no-image.jpg', 0, '6448484848', '', NULL, 'Australia', NULL, 'active', NULL, '2016-06-15 14:10:30', '2017-10-30 01:01:47', NULL, '41.228.12.180', NULL, NULL, NULL, 'yes'),
(143, 'karde akshay', '', 'akki@yahoo.com', '123456789', 'testing', '', '2017-09-14 05:45:28', 'Indian', 'Thane', 'male', '1992-04-08', NULL, NULL, 0, '7219129041', '7418529630', NULL, 'Australia', NULL, 'active', NULL, '2017-09-14 06:54:28', '2017-10-29 09:00:55', NULL, '::1', NULL, NULL, NULL, 'yes');
...
CREATE TABLE IF NOT EXISTS `pp_job_titles` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pp_newsletter` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pp_post_certification` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ID`),
  FULLTEXT KEY `certification_search` (`job_title`,`job_description`)
...
(58, 3, 'Hiiii', 3, 45, '240000-280000', '2017-10-28', 'pending', 'no', 'Indian', '2018-02-28', '', 'Does not matter', '2', 'hhh', 'Part Time', 1, 'yrjyr', '', '', '', 0, 'info-technologies-jobs-in-hhh-hiiii-58', '115.96.211.204', NULL, NULL, 'stiching', 0);
...
CREATE TABLE IF NOT EXISTS `pp_post_jobs` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `employer_ID` int(11) NOT NULL,
  `job_title` varchar(255) NOT NULL,
  `company_ID` int(11) NOT NULL,
...
(8, 7, 'Teachers And Administration Staff', 7, 5, '41000-50000', '2016-03-11', 'active', 'no', 'India', '2016-07-11', '', 'Certification', '3', 'Mumbai', 'Full Time', 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce venenatis arcu est. Phasellus vel dignissim tellus. Aenean fermentum fermentum convallis. Maecenas vitae ipsum sed risus viverra volutpat non ac sapien. Donec viverra massa at dolor imperdiet hendrerit. Nullam quis est vitae dui placerat posuere. Phasellus eget erat sit amet lacus semper consectetur. Sed a nisi nisi. Pellentesque hendrerit est id quam facilisis auctor a ut ante. Etiam metus arcu, sagittis vitae massa ac, faucibus tempus dolor. Sed et tempus ex. Aliquam interdum erat vel convallis tristique. Phasellus lectus eros, interdum ac sollicitudin vestibulum, scelerisque vitae ligula. Cras aliquam est id velit laoreet, et mattis massa ultrices. Ut aliquam mi nunc, et tempor neque malesuada in.', '', '', '', 0, 'ghi-company-jobs-in-mumbai-teachers-and-administration-staff-8', '101.50.114.8', NULL, NULL, 'marketing', 0),
(9, 8, 'Fitter', 8, 76, '36000-40000', '2016-03-11', 'active', 'no', 'India', '2016-07-11', '', 'Diploma', '1', 'Mumbai', 'Full Time', 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce venenatis arcu est. Phasellus vel dignissim tellus. Aenean fermentum fermentum convallis. Maecenas vitae ipsum sed risus viverra volutpat non ac sapien. Donec viverra massa at dolor imperdiet hendrerit. Nullam quis est vitae dui placerat posuere. Phasellus eget erat sit amet lacus semper consectetur. Sed a nisi nisi. Pellentesque hendrerit est id quam facilisis auctor a ut ante. Etiam metus arcu, sagittis vitae massa ac, faucibus tempus dolor. Sed et tempus ex. Aliquam interdum erat vel convallis tristique. Phasellus lectus eros, interdum ac sollicitudin vestibulum, scelerisque vitae ligula. Cras aliquam est id velit laoreet, et mattis massa ultrices. Ut aliquam mi nunc, et tempor neque malesuada in.', '', '', '', 0, 'jkl-company-jobs-in-mumbai-fitter-9', '101.50.114.8', NULL, NULL, 'photoshop, automotive mechanic', 0),
(10, 9, 'Electroplater', 9, 71, '61000-70000', '2016-03-11', 'active', 'no', 'India', '2016-07-11', '', 'Certification', '3', 'Mumbai', 'Full Time', 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce venenatis arcu est. Phasellus vel dignissim tellus. Aenean fermentum fermentum convallis. Maecenas vitae ipsum sed risus viverra volutpat non ac sapien. Donec viverra massa at dolor imperdiet hendrerit. Nullam quis est vitae dui placerat posuere. Phasellus eget erat sit amet lacus semper consectetur. Sed a nisi nisi. Pellentesque hendrerit est id quam facilisis auctor a ut ante. Etiam metus arcu, sagittis vitae massa ac, faucibus tempus dolor. Sed et tempus ex. Aliquam interdum erat vel convallis tristique. Phasellus lectus eros, interdum ac sollicitudin vestibulum, scelerisque vitae ligula. Cras aliquam est id velit laoreet, et mattis massa ultrices. Ut aliquam mi nunc, et tempor neque malesuada in.', '', '', '', 0, 'mno-company-jobs-in-mumbai-electroplater-10', '101.50.114.8', NULL, NULL, 'html, automotive mechanic', 0),
(11, 10, 'Beautician', 10, 5, '36000-40000', '2016-03-11', 'active', 'no', 'India', '2016-07-11', '', 'SSC', '4', 'Mumbai', 'Full Time', 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce venenatis arcu est. Phasellus vel dignissim tellus. Aenean fermentum fermentum convallis. Maecenas vitae ipsum sed risus viverra volutpat non ac sapien. Donec viverra massa at dolor imperdiet hendrerit. Nullam quis est vitae dui placerat posuere. Phasellus eget erat sit amet lacus semper consectetur. Sed a nisi nisi. Pellentesque hendrerit est id quam facilisis auctor a ut ante. Etiam metus arcu, sagittis vitae massa ac, faucibus tempus dolor. Sed et tempus ex. Aliquam interdum erat vel convallis tristique. Phasellus lectus eros, interdum ac sollicitudin vestibulum, scelerisque vitae ligula. Cras aliquam est id velit laoreet, et mattis massa ultrices. Ut aliquam mi nunc, et tempor neque malesuada in.', '', '', '', 0, 'mnt-comapny-jobs-in-mumbai-beautician-11', '101.50.114.8', NULL, NULL, 'seo, make up', 0),
(12, 11, 'Electrician', 11, 16, '51000-60000', '2016-03-11', 'active', 'no', 'India', '2016-07-11', '', 'HSC', '3', 'Mumbai', 'Full Time', 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce venenatis arcu est. Phasellus vel dignissim tellus. Aenean fermentum fermentum convallis. Maecenas vitae ipsum sed risus viverra volutpat non ac sapien. Donec viverra massa at dolor imperdiet hendrerit. Nullam quis est vitae dui placerat posuere. Phasellus eget erat sit amet lacus semper consectetur. Sed a nisi nisi. Pellentesque hendrerit est id quam facilisis auctor a ut ante. Etiam metus arcu, sagittis vitae massa ac, faucibus tempus dolor. Sed et tempus ex. Aliquam interdum erat vel convallis tristique. Phasellus lectus eros, interdum ac sollicitudin vestibulum, scelerisque vitae ligula. Cras aliquam est id velit laoreet, et mattis massa ultrices. Ut aliquam mi nunc, et tempor neque malesuada in.', '', '', '', 0, 'mnf-comapny-jobs-in-mumbai-electrician-12', '101.50.114.8', NULL, NULL, 'html, 3 phase electric wiring', 0),
(13, 12, 'Account Officer', 12, 18, '41000-50000', '2016-03-12', 'active', 'no', 'India', '2016-07-12', '', '10th fail', 'Fresh', 'Mumbai', 'Full Time', 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi a velit sed risus pulvinar faucibus. Nulla facilisi. Nullam vehicula nec ligula eu vulputate. Nunc id ultrices mi, ac tristique lectus. Suspendisse porta ultrices ultricies. Sed quis nisi vel magna maximus aliquam a vel nisl. Cras non rutrum diam. Nulla sed ipsum a felis posuere pharetra ut sit amet augue. Sed id nisl sodales, vulputate mi eu, viverra neque. Fusce fermentum, est ut accumsan accumsan, risus ante varius diam, non venenatis eros ligula fermentum leo. Etiam consectetur imperdiet volutpat. Donec ut pharetra nisi, eget pellentesque tortor. Integer eleifend dolor eu ex lobortis, ac gravida augue tristique. Proin placerat consectetur tincidunt. Nullam sollicitudin, neque eget iaculis ultricies, est justo pulvinar turpis, vulputate convallis leo orci at sapien.<br />\n<br />\nQuisque ac scelerisque libero, nec blandit neque. Nullam felis nisl, elementum eu sapien ut, convallis interdum felis. In turpis odio, fermentum non pulvinar gravida, posuere quis magna. Ut mollis eget neque at euismod. Interdum et malesuada fames ac ante ipsum primis in faucibus. Integer faucibus orci a pulvinar malesuada. Aenean at felis vitae lorem venenatis consequat. Nam non nunc euismod, consequat ligula non, tristique odio. Ut leo sapien, aliquet sed ultricies et, scelerisque quis nulla. Aenean non sapien maximus, convallis eros vitae, iaculis massa. In fringilla hendrerit nisi, eu pellentesque massa faucibus molestie. Etiam laoreet eros quis faucibus rutrum. Quisque eleifend purus justo, eget tempus quam interdum non.', '', '', '', 0, 'qwe-company-jobs-in-mumbai-account-officer-13', '115.186.165.234', NULL, NULL, 'accounting, marketing, ms office', 0),
(14, 13, 'Call Center Operator', 13, 70, '51000-60000', '2016-03-12', 'active', 'no', 'India', '2016-07-12', '', 'Diploma', '4', 'Mumbai', 'Full Time', 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi a velit sed risus pulvinar faucibus. Nulla facilisi. Nullam vehicula nec ligula eu vulputate. Nunc id ultrices mi, ac tristique lectus. Suspendisse porta ultrices ultricies. Sed quis nisi vel magna maximus aliquam a vel nisl. Cras non rutrum diam. Nulla sed ipsum a felis posuere pharetra ut sit amet augue. Sed id nisl sodales, vulputate mi eu, viverra neque. Fusce fermentum, est ut accumsan accumsan, risus ante varius diam, non venenatis eros ligula fermentum leo. Etiam consectetur imperdiet volutpat. Donec ut pharetra nisi, eget pellentesque tortor. Integer eleifend dolor eu ex lobortis, ac gravida augue tristique. Proin placerat consectetur tincidunt. Nullam sollicitudin, neque eget iaculis ultricies, est justo pulvinar turpis, vulputate convallis leo orci at sapien.<br />\n<br />\nQuisque ac scelerisque libero, nec blandit neque. Nullam felis nisl, elementum eu sapien ut, convallis interdum felis. In turpis odio, fermentum non pulvinar gravida, posuere quis magna. Ut mollis eget neque at euismod. Interdum et malesuada fames ac ante ipsum primis in faucibus. Integer faucibus orci a pulvinar malesuada. Aenean at felis vitae lorem venenatis consequat. Nam non nunc euismod, consequat ligula non, tristique odio. Ut leo sapien, aliquet sed ultricies et, scelerisque quis nulla. Aenean non sapien maximus, convallis eros vitae, iaculis massa. In fringilla hendrerit nisi, eu pellentesque massa faucibus molestie. Etiam laoreet eros quis faucibus rutrum. Quisque eleifend purus justo, eget tempus quam interdum non.', '', '', '', 0, 'asd-company-jobs-in-mumbai-call-center-operator-14', '115.186.165.234', NULL, NULL, 'marketting, ms office, electrician, 3 phase electric wiring', 0),
(15, 14, 'Computer Operator', 14, 22, '51000-60000', '2016-03-12', 'active', 'yes', 'India', '2016-07-12', '', 'Does not matter', '3', 'Mumbai', 'Full Time', 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi a velit sed risus pulvinar faucibus. Nulla facilisi. Nullam vehicula nec ligula eu vulputate. Nunc id ultrices mi, ac tristique lectus. Suspendisse porta ultrices ultricies. Sed quis nisi vel magna maximus aliquam a vel nisl. Cras non rutrum diam. Nulla sed ipsum a felis posuere pharetra ut sit amet augue. Sed id nisl sodales, vulputate mi eu, viverra neque. Fusce fermentum, est ut accumsan accumsan, risus ante varius diam, non venenatis eros ligula fermentum leo. Etiam consectetur imperdiet volutpat. Donec ut pharetra nisi, eget pellentesque tortor. Integer eleifend dolor eu ex lobortis, ac gravida augue tristique. Proin placerat consectetur tincidunt. Nullam sollicitudin, neque eget iaculis ultricies, est justo pulvinar turpis, vulputate convallis leo orci at sapien.<br />\n<br />\nQuisque ac scelerisque libero, nec blandit neque. Nullam felis nisl, elementum eu sapien ut, convallis interdum felis. In turpis odio, fermentum non pulvinar gravida, posuere quis magna. Ut mollis eget neque at euismod. Interdum et malesuada fames ac ante ipsum primis in faucibus. Integer faucibus orci a pulvinar malesuada. Aenean at felis vitae lorem venenatis consequat. Nam non nunc euismod, consequat ligula non, tristique odio. Ut leo sapien, aliquet sed ultricies et, scelerisque quis nulla. Aenean non sapien maximus, convallis eros vitae, iaculis massa. In fringilla hendrerit nisi, eu pellentesque massa faucibus molestie. Etiam laoreet eros quis faucibus rutrum. Quisque eleifend purus justo, eget tempus quam interdum non.', 'Sheshank', 'sheshank@singh.com', '9893999832', 0, 'xcv-company-jobs-in-mumbai-computer-operator-15', '115.186.165.234', NULL, NULL, 'ms office, html, photoshop', 0),
...
(54, 14, 'Control Room Operator', 14, 54, '5000-10000', '2017-09-28', 'active', 'yes', 'India', '2018-01-28', '', 'Does not matter', 'Less than 1', 'Mumbai', 'Full Time', 10, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi a velit sed risus pulvinar faucibus. Nulla facilisi. Nullam vehicula nec ligula eu vulputate. Nunc id ultrices mi, ac tristique lectus. Suspendisse porta ultrices ultricies. Sed quis nisi vel magna maximus aliquam a vel nisl. Cras non rutrum diam. Nulla sed ipsum a felis posuere pharetra ut sit amet augue. Sed id nisl sodales, vulputate mi eu, viverra neque. Fusce fermentum, est ut accumsan accumsan, risus ante varius diam, non venenatis eros ligula fermentum leo. Etiam consectetur imperdiet volutpat. Donec ut pharetra nisi, eget pellentesque tortor. Integer eleifend dolor eu ex lobortis, ac gravida augue tristique. Proin placerat consectetur tincidunt. Nullam sollicitudin, neque eget iaculis ultricies, est justo pulvinar turpis, vulputate convallis leo orci at sapien. Quisque ac scelerisque libero, nec blandit neque. Nullam felis nisl, elementum eu sapien ut, convallis interdum felis. In turpis odio, fermentum non pulvinar gravida, posuere quis magna. Ut mollis eget neque at euismod. Interdum et malesuada fames ac ante ipsum primis in faucibus. Integer faucibus orci a pulvinar malesuada. Aenean at felis vitae lorem venenatis consequat. Nam non nunc euismod, consequat ligula non, tristique odio. Ut leo sapien, aliquet sed ultricies et, scelerisque quis nulla. Aenean non sapien maximus, convallis eros vitae, iaculis massa. In fringilla hendrerit nisi, eu pellentesque massa faucibus molestie. Etiam laoreet eros quis faucibus rutrum. Quisque eleifend purus justo, eget tempus quam interdum non.', '', '', '', 0, 'xcv-company-jobs-in-mumbai-control-room-operator-54', '115.96.89.222', NULL, NULL, 'photoshop, html', 0);
...
CREATE TABLE IF NOT EXISTS `pp_post_training` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `employer_ID` int(11) NOT NULL,
  `job_title` varchar(255) NOT NULL,
  `company_ID` int(11) NOT NULL,
...
(10, 3, 'Mananga', 3, 3, '11000-15000', '2017-10-12', 'active', 'no', 'Canada', '2018-02-12', '', 'BE', '1', 'Sydney', 'Home Based', 1, 'ffffffff', '', '', '', 0, 'info-technologies-jobs-in-sydney-manangaqqqq111-11', '::1', NULL, NULL, 'dddd', 0),
(11, 3, 'Manangaqqqq111', 3, 10, '11000-15000', '2017-10-12', 'active', 'no', 'Indian', '2018-02-12', '', 'BE', '1', 'Sydney', 'Home Based', 1, 'aaaaa', 'sheshank', 'singh.sheshank@gmail.comm', '1234567890', 0, 'info-technologies-jobs-in-sydney-manangaqqqq111-11', '::1', NULL, NULL, 'hhh, aaa', 0),
(12, 3, 'Training', 3, 10, '281000-350000', '2017-10-28', 'pending', 'no', 'Australia', '2018-02-28', '', 'ACMA', '2', 'Sydneytt', 'Part Time', 1, 'tttttsa', 'sheshank', 'singh.sheshank@gmail.comm', '1234567890', 0, 'info-technologies-jobs-in-sydneytt-training-12', '::1', NULL, NULL, 'css, ms office', 0);
...
CREATE TABLE IF NOT EXISTS `pp_post_voulnteer` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `employer_ID` int(11) NOT NULL,
  `job_title` varchar(255) NOT NULL,
  `company_ID` int(11) NOT NULL,
...
(12, 3, 'Sfsa', 3, 5, '120000-140000', '2017-10-27', 'active', 'no', 'Sweden', '2018-02-27', '', 'MCS', '2', 'Sydneysa', 'Home Based', 1, 'asddddd', '', '', '', 0, 'info-technologies-jobs-in-sydneysa-sfsa-12', '::1', NULL, NULL, 'ads, das', 0);
...
CREATE TABLE IF NOT EXISTS `pp_prohibited_keywords` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pp_qualifications` (
...
CREATE TABLE IF NOT EXISTS `pp_salaries` (
  `ID` int(5) NOT NULL AUTO_INCREMENT,
  `val` varchar(25) DEFAULT NULL,
  `text` varchar(25) DEFAULT NULL,
  `display_order` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pp_scam` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pp_seeker_academic` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `seeker_ID` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pp_seeker_additional_info` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `seeker_ID` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pp_seeker_applied_for_job` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pp_seeker_experience` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `seeker_ID` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pp_seeker_resumes` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `seeker_ID` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pp_seeker_skills` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `seeker_ID` int(11) DEFAULT NULL,
...
('180ae13139c034124744c0fc3703c4d1', '49.203.248.46', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.75 Safari/537.36', 1509354642, 'a:5:{s:9:"user_data";s:0:"";s:20:"back_from_user_login";s:0:"";s:10:"user_email";s:15:"test3@test3.com";s:10:"first_name";s:5:"Danny";s:7:"cptcode";s:4:"G7K5";}'),
('20e3a7c8dae681e3f66d0b0e01a78b2e', '49.203.248.52', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.75 Safari/537.36', 1509354553, 'a:9:{s:9:"user_data";s:0:"";s:7:"user_id";s:1:"3";s:10:"user_email";s:15:"test3@test3.com";s:10:"first_name";s:5:"Danny";s:4:"slug";s:17:"info-technologies";s:13:"is_user_login";b:1;s:13:"is_job_seeker";b:0;s:11:"is_employer";b:1;s:20:"back_from_user_login";s:0:"";}'),
('3267f56df8812088bd6092d2d55b91db', '115.96.210.41', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36', 1509352551, 'a:10:{s:9:"user_data";s:0:"";s:7:"cptcode";s:4:"G7K5";s:20:"back_from_user_login";s:0:"";s:7:"user_id";s:1:"3";s:10:"user_email";s:15:"test3@test3.com";s:10:"first_name";s:5:"Danny";s:4:"slug";s:17:"info-technologies";s:13:"is_user_login";b:1;s:13:"is_job_seeker";b:0;s:11:"is_employer";b:1;}'),
('5c0551a74a02e62524717efda38c5cb3', '49.203.248.46', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.75 Safari/537.36', 1509354826, 'a:1:{s:9:"user_data";s:0:"";}');
...
CREATE TABLE IF NOT EXISTS `pp_skills` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pp_stories` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `seeker_ID` int(11) NOT NULL,
